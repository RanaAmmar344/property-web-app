...
const page = () => {
          ...
          <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
            <form action="#">
              ...
              <div className="flex items-center pl-6 mb-3 bg-white rounded-full">
                ...
                <input className="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="email" placeholder="example@coderbros.com"/>
              </div>
              <div className="flex items-center pl-6 mb-3 bg-white rounded-full">
                <span className="inline-block pr-3 py-2 border-r border-gray-50">
  ...
  /            </div>
              <div className="flex items-center pl-6 mb-6 bg-white rounded-full">
                ...
                <input className="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="password" placeholder="Repeat passwor/d"/>
              </div>
              <div className="inline-flex mb-10">
                <input className="mr-4" type="checkbox"/>
                <p className="-mt-2 text-sm text-gray-200">By singning up, you agree to our <a className="t/ext-white" href="#">Terms, Data Policy</a>and <a className="text-white" href="#">Cookies.</a></p>
              </div>
